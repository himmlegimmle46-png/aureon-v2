...
const TOOL_KEY_VARIANTS: Variant[] = [
  { id: "rust-serenity-1", label: "Serenity Cheat 1 day", priceLabel: "$4.99", priceId: "price_1T3vrzISP3QHCCrMvWLlPKkC", inStock: true },
  { id: "rust-serenity-7", label: "Serenity Cheat 7 days", priceLabel: "$24.99", priceId: "price_1T3vsAISP3QHCCrMTE9MiEht", inStock: true },
  { id: "rust-serenity-30", label: "Serenity Cheat 30 days", priceLabel: "$49.99", priceId: "price_1T3vsOISP3QHCCrMC4MLqFWv", inStock: true },
];

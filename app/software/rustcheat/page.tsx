...
const TOOL_KEY_VARIANTS: Variant[] = [
  { id: "Serenity Cheat 1", label: "Serenity Cheat 1 day", priceLabel: "$4.99", priceId: "price_1T3vrzISP3QHCCrMvWLlPKkC", inStock: true },
  { id: "Serenity Cheat 7", label: "Serenity Cheat 7 days", priceLabel: "$24.99", priceId: "price_1T3vsAISP3QHCCrMTE9MiEht", inStock: true },
  { id: "Serenity Cheat 30", label: "Serenity Cheat 30 days", priceLabel: "$49.99", priceId: "price_1T3vsOISP3QHCCrMC4MLqFWv", inStock: true },
];
      ...
      <Card className="p-5">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <div className="pt-2 text-sm text-white/70">After checkout, you’ll see delivery instructions (key / access steps).</div>
          </div>
